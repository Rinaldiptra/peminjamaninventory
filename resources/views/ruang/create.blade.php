...
<div class="mt-5">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="" name="id_ruang">
  </div>
  <div class="form-group">
    <label for="naama_ruang">Nama ruang</label>
    <input type="text" class="form-control" id="" name="nama_ruang">
  </div>
  <div class="form-group">
    <label for="kode_ruang">kode ruang</label>
    <input type="text" class="form-control" id="" name="kode_ruang">
  </div>
  <div class="form-group">
